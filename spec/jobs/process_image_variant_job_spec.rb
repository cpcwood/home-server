RSpec.describe ProcessImageVariantJob, type: :job do
  ...
  before(:each) do
    ...
    allow_any_instance_of(Image).to receive(:process_variants).and_return(true)
  end
  ...
  it 'Password reset email sent' do
    ...
    ProcessImageVariantJob.perform_now(image_attachment: image.image_file, variant: variant_details)
  end
end