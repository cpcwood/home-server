feature 'projects feature', feature: true do
  ...
  context 'admin user' do
    ...
    scenario 'create code snippet' do
      ...
      find_field('project[project_image_attributes][image_file]').set(Rails.root.join('spec/files/sample_image.jpg'))
      click_on('Submit')
      ...
      expect(Project.first.main_project_image.image_file.attached?).to be(true)
