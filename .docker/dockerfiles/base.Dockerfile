...
RUN bundle exec rails assets:precompile && \
    ...
    rm -rf $APP_HOME/tmp/* && \
    rm -rf $APP_HOME/vendor/bundle/ruby/3.2.1/cache/ && \
    find $APP_HOME/vendor/bundle/ruby/3.2.1/gems/ -name "*.c" -delete && \
    find $APP_HOME/vendor/bundle/ruby/3.2.1/gems/ -name "*.o" -delete
